...
export const INVARIANTS: Invariant[] = [
  ...
  { id: 'inv-task-done-without-verdict', text: 'A task marked done or verified needs a reviewer verdict recorded in reality; the kernel asks for one rather than assuming it.', source: said(152), raise: 'question' },
  { id: 'inv-task-verified-without-green', text: 'A task marked verified must have every targeted test passing and fresh; otherwise it raises as work still to do.', source: said(152), raise: 'task' },
];
