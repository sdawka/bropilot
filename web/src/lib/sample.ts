...
export const SAMPLE_GRAPH: Graph = {
  ...
  edges: [
    ...
    // why → what: purpose, goal and hypothesis anchor the capabilities
    ...
    // who → what: personas exercise the capabilities
    ...
    // spec → code: implementation realises capabilities, honours constraints
    ...
    // domain ↔ implementation: the serialised shape carries the domain objects
    ...
    // the narrative flows from the purpose: every node is reachable from it
